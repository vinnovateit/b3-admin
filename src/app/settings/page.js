...
export default function Settings() {
  ...
  return (
    <div className="relative min-h-screen bg-black/50">
      ...
      <p className="text-white p-8 text-[20px] font-[700]">SETTINGS</p>
      <div className="flex justify-center">
      <form onSubmit={handleSubmit} className="mt-30 w-150.5 h-119.5 flex flex-col justify-center    rounded-[25px] bg-[rgba(255,255,255,0.10)] backdrop-blur-md border border-white/30 inset-shadow-sm/30 shadow-xl p-8 gap-6">
      ...
      <label className="text-[20px]">Registration Number</label>
